 ...
 */
package id.co.kmn.webui.security.right;

import com.trg.search.Filter;
import id.co.kmn.backend.model.SecRight;
import id.co.kmn.backend.model.SecTyp;
import id.co.kmn.backend.service.SecurityService;
import id.co.kmn.backend.util.HibernateSearchObject;
import id.co.kmn.webui.security.right.model.SecRightListModelItemRenderer;
import id.co.kmn.webui.security.right.model.SecRightSecTypListModelItemRenderer;
import id.co.kmn.webui.security.right.report.SecRightSimpleDJReport;
...
public class SecRightListCtrl extends GFCBaseListCtrl<SecRight> implements Serializable {
     ...
     * see: id.co.kmn.webui.branch.model.BranchListModelItemRenderer.java <br>
     *
     * @param event
     * @throws Exception
     */
