 ...
 */
package id.co.kmn.backend.util;
...
public final class CustomDataAccessUtils {
    ...
    /**
     * @param col       of Type Collection<Object[]>
     * @param beanClass
     * @param args      Names of des Property in the <code>beanClass</code>
     * @return
     */
    ...
    /**
     * @param col       from Type Collection<Object[]>
     * @param beanClass
     * @param args      Names of des Property in the <code>beanClass</code>
     * @param argsClass Typs of the <code>args</code>
     * @return
     */
