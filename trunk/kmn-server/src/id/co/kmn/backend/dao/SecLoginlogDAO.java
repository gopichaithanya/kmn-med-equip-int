...
public interface SecLoginlogDAO {
     ...
     * @param clientAddress User IP address | User IP Adresse
     * @param sessionId     Session ID | Session ID
     * @param browserType   Brwoser Type | Browser Typ
     * @param status        Status (success/failed) | Status (erfolgreich / abgewiesen)
     * @return SecLoginlog
     */
