 ...
 * Time: 1:18 AM
 */
@WebService(name = "KmnService", targetNamespace = "http://localhost:9090/kmn/KmnService/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface KmnService {
    ...
    @RequestWrapper(localName = "getPatientList", targetNamespace = "http://localhost:9090/kmn/KmnService/", className = "id.co.kmn.services.wsdl.client.GetPatientList")
    @ResponseWrapper(localName = "getPatientListResponse", targetNamespace = "http://localhost:9090/kmn/KmnService/", className = "id.co.kmn.services.wsdl.client.GetPatientListResponse")
    ...
    @RequestWrapper(localName = "putPatientData", targetNamespace = "http://localhost:9090/kmn/KmnService/", className = "id.co.kmn.services.wsdl.client.PutPatientData")
    @ResponseWrapper(localName = "putPatientDataResponse", targetNamespace = "http://localhost:9090/kmn/KmnService/", className = "id.co.kmn.services.wsdl.client.PutPatientDataResponse")
