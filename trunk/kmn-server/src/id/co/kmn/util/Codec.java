...
public class Codec {
    ...
    public enum EquipmentResult implements CodecInterface {
        ER1("1","NUMERIC"),
        ER2("2","IMAGE"),
        ER3("3","GRAPHIC"),
        ER4("4","PHOTO"),
        ER5("5","NUMERIC & GRAPHIC"),
        ER6("6","NUMERIC & PHOTO"),
        ER7("7","NUMERIC & IMAGE");
        ...
        private EquipmentResult(String _value, String _label) {
            this.value = _value;
            this.label = _label;
        }
    ...
    public enum SupportFlag implements CodecInterface {
        SF0("0","Not Support"),
        SF1("1","Support");
        ...
        private SupportFlag(String _value, String _label) {
            this.value = _value;
            this.label = _label;
        }
