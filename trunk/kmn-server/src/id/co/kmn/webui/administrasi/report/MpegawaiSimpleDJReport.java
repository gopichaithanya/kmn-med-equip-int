package id.co.kmn.webui.administrasi.report;
...
import id.co.kmn.backend.service.OfficeService;
 ...
 */
public class MpegawaiSimpleDJReport extends Window implements Serializable {
	...
	public MpegawaiSimpleDJReport(Component parent) throws InterruptedException {
		super();
