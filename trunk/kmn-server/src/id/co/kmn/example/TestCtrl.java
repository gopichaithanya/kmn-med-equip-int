 ...
 */
package id.co.kmn.example;

import com.trg.search.Filter;
import id.co.kmn.backend.model.Branche;
import id.co.kmn.backend.model.Customer;
import id.co.kmn.backend.model.Office;
import id.co.kmn.backend.model.SecLoginlog;
import id.co.kmn.backend.service.*;
import id.co.kmn.backend.util.HibernateSearchObject;
import id.co.kmn.gui.service.GuiLoginLoggingService;
import id.co.kmn.services.report.service.ReportService;
import id.co.kmn.util.ZkossComponentTreeUtil;
import id.co.kmn.webui.customer.model.CustomerListModelItemRenderer;
import id.co.kmn.webui.util.MultiLineMessageBox;
import id.co.kmn.webui.util.MyThemeProvider;
...
public class TestCtrl extends GenericForwardComposer implements Serializable {
    ...
    public void onClick$button_insertCustomers(Event event) throws InterruptedException {
        ...
        for (int j = 0; j < countRecords; j++) {
            ...
            customer.putKunMahnsperre(Boolean.FALSE);
    ...
    public void onClick$btn_CompileReport(Event event) {
        ...
        getReportService().compileReport("/id/ac/forsthaus/webui/reports/order/Test_Report_subreportAuftrag.jrxml");
