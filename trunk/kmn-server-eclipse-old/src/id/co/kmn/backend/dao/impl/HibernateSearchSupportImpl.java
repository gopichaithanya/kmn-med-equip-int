...
import id.co.kmn.backend.dao.HibernateSearchSupport;
...
public class HibernateSearchSupportImpl implements HibernateSearchSupport {
    ...
    /*
      ...
      *
      * @see
      * id.co.kmn.backend.dao.impl.HibernateSearchSupport#count(java.lang.
    ...
    /*
      ...
      *
      * @see
      * id.co.kmn.backend.dao.impl.HibernateSearchSupport#count(com.trg.search
      * .ISearch)
      */
    ...
    /*
      ...
      *
      * @see
      * id.co.kmn.backend.dao.impl.HibernateSearchSupport#generateQL(java.
    ...
    /*
      ...
      *
      * @see
      * id.co.kmn.backend.dao.impl.HibernateSearchSupport#generateRowCountQL
    ...
    /*
      ...
      *
      * @see
      * id.co.kmn.backend.dao.impl.HibernateSearchSupport#getFilterFromExample
      * (java.lang.Object)
      */
    ...
    /*
      ...
      *
      * @see
      * id.co.kmn.backend.dao.impl.HibernateSearchSupport#search(java.lang
      * .Class, com.trg.search.ISearch)
      */
    ...
    /*
      ...
      *
      * @see
      * id.co.kmn.backend.dao.impl.HibernateSearchSupport#search(com.trg.search
      * .ISearch)
      */
    @SuppressWarnings("unchecked")
    ...
    /*
      ...
      *
      * @see
      * id.co.kmn.backend.dao.impl.HibernateSearchSupport#searchAndCount(java
    ...
    /*
      ...
      *
      * @see
      * id.co.kmn.backend.dao.impl.HibernateSearchSupport#searchAndCount(com
      * .trg.search.ISearch)
      */
    @SuppressWarnings("unchecked")
    ...
    /*
      ...
      *
      * @see
      * id.co.kmn.backend.dao.impl.HibernateSearchSupport#searchUnique(java
      * .lang.Class, com.trg.search.ISearch)
      */
    @SuppressWarnings("unchecked")
    ...
    /*
      ...
      *
      * @see
      * id.co.kmn.backend.dao.impl.HibernateSearchSupport#searchUnique(com
      * .trg.search.ISearch)
      */
