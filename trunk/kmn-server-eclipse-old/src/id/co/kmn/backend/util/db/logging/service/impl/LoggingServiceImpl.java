package id.co.kmn.backend.util.db.logging.service.impl;

import id.co.kmn.backend.model.HibernateEntityStatistics;
import id.co.kmn.backend.model.HibernateStatistics;
import id.co.kmn.backend.util.db.logging.service.LoggingService;
...
public class LoggingServiceImpl implements LoggingService {
    ...
    /*
      ...
      *
      * @see
      * id.co.kmn.backend.util.db.logging.service.LoggingService#saveStatistics
