 ...
 */
package id.co.kmn.backend.service.impl;

import id.co.kmn.backend.bean.DummyBean;
import id.co.kmn.backend.bean.ListLongSumBean;
import id.co.kmn.backend.dao.CountryCodeDAO;
import id.co.kmn.backend.dao.Ip2CountryDAO;
import id.co.kmn.backend.dao.SecLoginlogDAO;
import id.co.kmn.backend.model.CountryCode;
import id.co.kmn.backend.model.Ip2Country;
import id.co.kmn.backend.model.LoginStatus;
import id.co.kmn.backend.model.SecLoginlog;
import id.co.kmn.backend.service.LoginLoggingService;
