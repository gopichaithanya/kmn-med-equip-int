...
public interface GuiLoginLoggingPolicService {
     ...
     *
     * @param userName      Username, who is succesfully logged in.
     * @param userId        ID des Users.
     * @param sessionId     ZK Session Id.
     * @param clientAddress Remote Ip from the client.
     */
     ...
     *
     * @param userName      Username, who is failed to login.
     * @param sessionId     ZK Session Id.
     * @param clientAddress Remote Ip from the client.
     */
