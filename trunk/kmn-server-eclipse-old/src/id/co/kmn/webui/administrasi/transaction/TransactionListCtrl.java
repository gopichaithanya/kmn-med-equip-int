...
public class TransactionListCtrl extends GFCBaseListCtrl<Tmedequipment> implements Serializable {
    ...
    protected Listheader listheader_TransactionList_Branch; // autowired
    protected Listheader listheader_TransactionList_Status; // autowired
    protected Listheader listheader_TransactionList_TrxDate; // autowired
    ...
    public void doFillListbox() {
        ...
        listheader_TransactionList_Branch.setSortAscending(new FieldComparator(ConstantUtil.BRANCH_CODE, true));
        listheader_TransactionList_Branch.setSortDescending(new FieldComparator(ConstantUtil.BRANCH_CODE, false));
        listheader_TransactionList_Status.setSortAscending(new FieldComparator(ConstantUtil.CIS_STATUS, true));
        listheader_TransactionList_Status.setSortDescending(new FieldComparator(ConstantUtil.CIS_STATUS, false));
        listheader_TransactionList_TrxDate.setSortAscending(new FieldComparator(ConstantUtil.TRX_DATE, true));
        listheader_TransactionList_TrxDate.setSortDescending(new FieldComparator(ConstantUtil.TRX_DATE, false));
        ...
        searchObj.addSort(ConstantUtil.TRX_DATE, false);
