 ...
 * Time: 7:34 AM
 */
public class ProducerLookup extends Window implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger logger = Logger.getLogger(ProducerLookup.class);
    ...
    // the windows title
    private final String _title = Labels.getLabel("message.Information.ExtendedSearch") + " / Producer";
    ...
    private Mmedproducer obj = null;

    // The service from which we get the data
    private ProducerService objService;
     ...
     */
    public static Mmedproducer show(Component parent) {
        return new ProducerLookup(parent).getObj();
    }
     ...
     * @param parent
     */
    private ProducerLookup(Component parent) {
    ...
    private void createBox() {
        ...
        List<Mmedproducer> resultList = (List<Mmedproducer>) ro.getList();
    ...
    final class SearchBoxItemRenderer implements ListitemRenderer {
        ...
        public void render(Listitem item, Object data) throws Exception {
            ...
            Mmedproducer obj = (Mmedproducer) data;

            Listcell lc = new Listcell(obj.getProdName());
            lc.setParent(item);
    ...
    public void onDoubleClicked(Event event) {
        ...
        if (this.listbox.getSelectedItem() != null) {
            ...
            Mmedproducer obj = (Mmedproducer) li.getAttribute("data");
    ...
    public final class OnPagingEventListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            String searchText = ProducerLookup.this._textbox.getValue();
            // refresh the list
    ...
    final class OnCloseListener implements EventListener {
        ...
        public void onEvent(Event event) throws Exception {
            ...
            if (ProducerLookup.this.listbox.getSelectedItem() != null) {
                Listitem li = ProducerLookup.this.listbox.getSelectedItem();
                Mmedproducer obj = (Mmedproducer) li.getAttribute("data");
    ...
    public Mmedproducer getObj() {
        return obj;
    }

    public void setObj(Mmedproducer obj) {
        this.obj = obj;
    }

    public ProducerService getObjService() {
        if (this.objService == null) {
            this.objService = (ProducerService) SpringUtil.getBean("producerService");
        }
        return objService;
    }

    public void setObjService(ProducerService objService) {
