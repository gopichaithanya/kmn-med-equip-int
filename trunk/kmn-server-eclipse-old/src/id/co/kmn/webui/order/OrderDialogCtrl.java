 ...
 */
package id.co.kmn.webui.order;

import com.trg.search.Filter;
import id.co.kmn.UserWorkspace;
import id.co.kmn.backend.model.Customer;
import id.co.kmn.backend.model.Order;
import id.co.kmn.backend.model.Orderposition;
import id.co.kmn.backend.service.BrancheService;
import id.co.kmn.backend.service.CustomerService;
import id.co.kmn.backend.service.OrderService;
import id.co.kmn.backend.util.HibernateSearchObject;
import id.co.kmn.webui.order.model.OrderSearchCustomerListModelItemRenderer;
import id.co.kmn.webui.order.report.OrderDJReport;
import id.co.kmn.webui.orderposition.model.OrderpositionListModelItemRenderer;
...
import id.co.kmn.webui.util.pagging.PagedListWrapper;
...
public class OrderDialogCtrl extends GFCBaseCtrl implements Serializable {
    ...
    public void onCreate$orderDialogWindow(Event event) throws Exception {
        ...
        if (args.containsKey("order")) {
            System.out.println("if (args.containsKey(order))");
            ...
            System.out.println("else if (args.containsKey(order))");
            setOrder(null);
        }
        ...
        if (getOrder() != null) {
            System.out.println("if (getOrder() != null)");
            if (!getOrder().isNew()) {
                System.out.println("if (!getOrder().isNew())");
                ...
                System.out.println("else if (!getOrder().isNew())");
            }
        } else {
            System.out.println("else if (getOrder() != null)");
        }
