...
import id.co.kmn.webui.security.user.model.UserListModelItemRenderer;
import id.co.kmn.webui.security.user.report.UserSimpleDJReport;
...
public class UserListCtrl extends GFCBaseListCtrl<SecUser> implements Serializable {
     ...
     * see: id.co.kmn.webui.user.model.UserListModelItemRenderer.java <br>
     *
     * @param event
     * @throws Exception
     */
