...
import id.co.kmn.webui.security.role.model.SecRoleListModelItemRenderer;
import id.co.kmn.webui.security.role.report.SecRoleSimpleDJReport;
...
public class SecRoleListCtrl extends GFCBaseListCtrl<SecRole> implements Serializable {
     ...
     * see: id.co.kmn.webui.security.role.model.SecRoleListModelItemRenderer.
     * java <br>
     *
     * @param event
     * @throws Exception
