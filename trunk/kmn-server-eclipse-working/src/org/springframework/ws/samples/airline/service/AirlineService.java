...
public interface AirlineService {
     ...
     * username. If a {@link org.springframework.ws.samples.airline.domain.FrequentFlyer} is specified, the first and last name are looked up in the database.
     *
     * @param flightNumber  the number of the flight to book
     * @param departureTime the departure time of the flight to book
     * @param passengers    the list of passengers for the flight to book. Can be either {@link org.springframework.ws.samples.airline.domain.Passenger} objects with
     *                      a first and last name, or {@link org.springframework.ws.samples.airline.domain.FrequentFlyer} objects with a username.
     ...
     * @throws NoSuchFrequentFlyerException if a specified {@link org.springframework.ws.samples.airline.domain.FrequentFlyer} cannot be found
