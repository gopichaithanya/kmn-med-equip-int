...
public class Transmitter implements TextListener, ItemListener, Runnable {
	...
	public Transmitter(SerialPortObject	owner, int rows, int cols) {
		super();
		this.first = true;
	...
	public Transmitter(SerialPortObject	owner, int rows, int cols, boolean modemMode) {
