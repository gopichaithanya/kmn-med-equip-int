...
public class SerialPortObject implements SerialPortEventListener, MouseListener, CommPortOwnershipListener, InterfaceEvent {
    ...
    private int ctsCount = 0;


    public SerialPortObject(CommPortIdentifier portID, boolean threadRcv,
                            boolean friendly, boolean silentReceive, 
                            boolean modemMode, int rcvDelay, 
                            InterfaceEvent intEvt) throws PortInUseException {
        super();
        this.intEvt = intEvt;
    ...
    */
    public void serialEvent(SerialPortEvent	ev) {
        ...
        case SerialPortEvent.CD:
            System.out.println(port.getName()+ " SerialPortEvent.CD " + SerialPortEvent.CD);
            break;
        case SerialPortEvent.CTS:
            System.out.println(port.getName()+ " SerialPortEvent.CTS " + SerialPortEvent.CTS);
            ctsCount++;
            if (ctsCount == 2) {
                ctsCount = 0;
                this.intEvt.onReceive(this.receiver.getResultText());
                this.receiver.setResultText("");
            }
            break;
        case SerialPortEvent.DSR:
            System.out.println(port.getName()+ " SerialPortEvent.DSR " + SerialPortEvent.DSR);
            break;
