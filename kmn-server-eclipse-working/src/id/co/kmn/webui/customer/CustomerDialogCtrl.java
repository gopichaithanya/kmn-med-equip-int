 ...
 */
package id.co.kmn.webui.customer;
...
import id.co.kmn.backend.service.ChartService;
...
import id.co.kmn.webui.util.searchdialogs.BranchAdvancedSearchListBox;
import id.co.kmn.webui.util.searchdialogs.BranchExtendedSearchListBox;
import id.co.kmn.webui.util.searchdialogs.BranchSimpleSearchListBox;
...
public class CustomerDialogCtrl extends GFCBaseCtrl implements Serializable {
    ...
    public void doWriteBeanToComponents(Customer aCustomer) {
        ...
        kunMahnsperre.setChecked(aCustomer.checkKunMahnsperre());
    ...
    public void doSave() throws InterruptedException {
        ...
        if (kunMahnsperre.isChecked() == true) {
            aCustomer.putKunMahnsperre(true);
        } else {
            aCustomer.putKunMahnsperre(false);
        }
