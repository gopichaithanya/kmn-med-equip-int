 ...
 */
package id.co.kmn.webui.reports.util;

//import id.co.kmn.webui.JasperObject;
...
public class JRreportWindow extends Window implements Serializable {
    ...
    //private transient JasperObject report;
    ...
    private void createReport() throws FileNotFoundException {
        ...
        /* Disabled by valeo beacuse of using zkex.jar (zk EE)
