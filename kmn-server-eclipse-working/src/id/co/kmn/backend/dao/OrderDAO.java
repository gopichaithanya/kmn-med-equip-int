...
public interface OrderDAO {
     ...
     *
     * @param auf_nr the order number / die Auftragsnummer
     * @return Order / Order (Auftrag)
     */
     ...
     * zurueck.<br>
     *
     * @param office office / office (Niederlassung)
     * @return List of Order / Liste of Orders (Auftraege)
     */
     ...
     *
     * @param auf_nr order number / Auftragsnummer
     */
