...
//        SOAPAction: "http://192.168.13.10:2221/apps/kmn/IntegrasiAlat/getPatientList"
        ...
        mimeHeader.addHeader("SOAPAction", "\""+this.CIS_SOAP_ENV_URI+"getPatientList\"");
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("CisService.createGetPatientsRequest" + message.toString());
        }
        return message;
    }
...
//        SOAPAction: "http://192.168.13.10:2221/apps/kmn/IntegrasiAlat/getPatientList"
        ...
        mimeHeader.addHeader("SOAPAction", "\""+this.CIS_SOAP_ENV_URI+"putPatientData\"");
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("CisService.createPutPatientDataRequest: " + message.toString());
        }
        return message;
    }
