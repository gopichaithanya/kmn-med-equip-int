...
public class MultiLineMessageBox extends Messagebox implements Serializable {
     ...
     * @param icon    The icon to display. <br>
     ...
     * @param buttons MultiLineMessageBox.CANCEL<br>
     ...
     * @param padding true = Added an empty line before and after the message.<br>
     * @return
