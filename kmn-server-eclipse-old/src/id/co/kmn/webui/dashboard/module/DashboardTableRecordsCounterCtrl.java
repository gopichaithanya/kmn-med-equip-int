 ...
 */
package id.co.kmn.webui.dashboard.module;

import id.co.kmn.backend.service.CommonService;
...
public class DashboardTableRecordsCounterCtrl extends Div implements Serializable {
    ...
    private void createComponents() {
        ...
        cap.setImage("/images/icons/database_blue_16x16.gif");
     ...
     * @param tableName
     * @param value
     * @param color     | black, gray, silver, brown, red, yellow, green, blue, brown,
     *                  cyan
     */
