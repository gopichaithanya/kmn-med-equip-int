...
public class Auftragposition implements java.io.Serializable {
    ...
    public Auftragposition(int aupId, Auftrag auftrag, Artikel artikel, Integer aupPosition, BigDecimal aupMenge, BigDecimal aupEinzelwert, BigDecimal aupGesamtwert) {
        this.aupId = aupId;
        this.auftrag = auftrag;
