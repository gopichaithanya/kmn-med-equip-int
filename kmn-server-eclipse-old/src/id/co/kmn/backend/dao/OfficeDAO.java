...
public interface OfficeDAO {
     ...
     *
     * @param fil_nr / the office number / die Niederlassungs Nummer
     * @return Office / Office
     */
     ...
     * %string% enthaelt.<br>
     *
     * @param string Name1 of the office / Name1 vom Office
     * @return List of Offices / Liste of Offices
     */
     ...
     * %string% enthaelt.<br>
     *
     * @param string Number of the office / Nummer vom Office
     * @return List of Offices / Liste of Offices
     */
