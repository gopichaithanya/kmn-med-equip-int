...
public interface CustomerDAO {
     ...
     * @param orderByFieldName FieldName for the OrderBy clause / Feldname fuer die OrderBy
     *                         Klausel
     * @param ascending        sort order ascending=true / Sortierung aufsteigend=true
     * @return List of Customers / Liste von Kunden
     */
     ...
     *
     * @param kun_nr Customer Number / Kunden Nummer
     * @return Customer / Kunde
     */
     ...
     * enthaelt.<br>
     *
     * @param string Matchcode of the customer / Matchcode des Kunden
     ...
     * enthaelt.<br>
     *
     * @param string CtityName of the customer / Stadtnamen des Kunden
     * @return List of Customers / Liste of Kunden
     */
     ...
     * enthaelt.<br>
     *
     * @param string Name1 of the customer / Name1 des Kunden
     * @return List of Customers / Liste of Kunden
     */
     ...
     * enthaelt.<br>
     *
     * @param string Name2 of the customer / Name2 des Kunden
     * @return List of Customers / Liste of Kunden
     */
     ...
     *
     * @param id / the persistence identifier of the office / der PrimaerKey
     *           der Niederlassung
     * @return List of Customers / Liste of Kunden
     */
