 ...
 */
package id.co.kmn.webui.security.groupright;

import com.trg.search.Filter;
import id.co.kmn.backend.model.SecGroup;
import id.co.kmn.backend.model.SecGroupright;
import id.co.kmn.backend.model.SecRight;
import id.co.kmn.backend.service.SecurityService;
import id.co.kmn.backend.util.HibernateSearchObject;
import id.co.kmn.webui.security.groupright.model.SecGrouprightDialogGroupListModelItemRenderer;
import id.co.kmn.webui.security.groupright.model.SecGrouprightRightListModelItemRenderer;
