...
public final class FDStatistic {
    ...
    FDStatistic(long startTime, int activeDesktopCount, int totalSessionCount, int activeSessionCount,
                int totalDesktopCount, int totalUpdateCount, int activeUpdateCount) {
        super();
