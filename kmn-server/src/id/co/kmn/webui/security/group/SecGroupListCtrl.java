 ...
 */
package id.co.kmn.webui.security.group;
...
import id.co.kmn.webui.security.group.model.SecGroupListModelItemRenderer;
import id.co.kmn.webui.security.group.report.SecGroupSimpleDJReport;
...
public class SecGroupListCtrl extends GFCBaseListCtrl<SecGroup> implements Serializable {
     ...
     * see:
     * id.co.kmn.webui.security.group.model.SecGroupListModelItemRenderer
     * .java <br>
     *
     * @param event
     * @throws Exception
