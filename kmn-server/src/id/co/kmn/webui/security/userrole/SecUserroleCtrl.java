 ...
 */
package id.co.kmn.webui.security.userrole;

import id.co.kmn.backend.model.SecRole;
import id.co.kmn.backend.model.SecUser;
import id.co.kmn.backend.model.SecUserrole;
...
import id.co.kmn.webui.security.groupright.SecGrouprightCtrl;
import id.co.kmn.webui.security.userrole.model.SecUserroleRoleListModelItemRenderer;
import id.co.kmn.webui.security.userrole.model.SecUserroleUserListModelItemRenderer;
import id.co.kmn.webui.util.GFCBaseCtrl;
import id.co.kmn.webui.util.SelectionCtrl;
...
public class SecUserroleCtrl extends GFCBaseCtrl implements Serializable, SelectionCtrl<SecUser> {
    ...
    /*
      * (non-Javadoc)
      *
      * @see id.co.kmn.webui.util.SelectionCtrl#getSelected()
      */
    @Override
