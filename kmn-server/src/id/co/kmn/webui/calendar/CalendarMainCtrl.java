 ...
 */
package id.co.kmn.webui.calendar;

import id.co.kmn.backend.model.MyCalendarEvent;
import id.co.kmn.backend.model.SecUser;
import id.co.kmn.backend.service.MyCalendarEventService;
import id.co.kmn.policy.model.UserImpl;
import id.co.kmn.webui.calendar.model.CalendarDateFormatter;
import id.co.kmn.webui.calendar.model.MySimpleCalendarEvent;
...
public class CalendarMainCtrl extends GFCBaseCtrl implements Serializable {
    ...
    public void synchronizeModel() throws ParseException {
        ...
        for (MyCalendarEvent myCalendarEvent : list) {
            ...
            sce.setLocked(myCalendarEvent.checkLocked());
