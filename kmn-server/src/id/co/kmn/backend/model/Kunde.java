...
public class Kunde implements java.io.Serializable {
    ...
    public Kunde(int kunId, Filiale filiale, Branche branche, String kunNr, String kunMatchcode, String kunName1, String kunName2, String kunOrt, Short kunMahnsperre, Set<Auftrag> auftrags) {
        this.kunId = kunId;
        this.filiale = filiale;
